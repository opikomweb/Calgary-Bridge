...
const categoryIntent: Record<string, ResourceCategory[]> = {
  ...
  shovel: ["essentials"],
  shovelling: ["essentials"],
  shoveling: ["essentials"],
  sidewalk: ["essentials"],
  bylaw: ["essentials"],
  "income support": ["jobs"],
  unemployed: ["jobs"],
...
const relatedCategories: Record<ResourceCategory, ResourceCategory[]> = {
  ...
  community: ["arts", "volunteering", "family", "youth", "indigenous", "lgbtq", "sports"],
  lgbtq: ["community", "mental-health", "youth", "healthcare"],
  indigenous: ["community", "arts", "healthcare", "education"],
  youth: ["family", "education", "arts", "community", "mental-health", "sports"],
  arts: ["community", "tourism", "youth", "family"],
  logistics: ["business", "storage", "workspace"],
  tourism: ["arts", "family", "community", "farmers-market", "sports"],
  sports: ["community", "youth", "family", "tourism"],
