...
export const calgaryResources: Resource[] = [
  ...
  },
  {
    ...
    description: {
      ...
      zh: "阿尔伯塔省政府为65岁以上低收入长者提供的项目：收入补助、牙科和视光援助及地税延付。",
    },
    servicesOffered: [
  ...
  },
  {
    ...
    description: {
      ...
      ar: "بعد إتمام التسجيل الإقليمي، يجب الحصول على رخصة أعمال بلدية محلية.",
  ...
  },
  {
    ...
    description: {
      ...
      ar: "كلية غير ربحية في كالجاري تقدم تدريبًا عمليًا ميسور التكلفة نحو وظائف مطلوبة.",
  ...
  },
  {
    ...
    summary: {
      ...
      ar: "لحم بقري يتغذى على العشب مع التوصيل.",
      zh: "草饲牛肉送货上门。",
    },
