        ...
        <>
          ...
          <section className="px-6 md:px-8 lg:px-12 pb-12 md:pb-20 max-w-[1200px] mx-auto relative z-10">
            <div className="pb-8 md:pb-10">
              ...
              >
                <p className="text-xs font-bold text-[#1D4ED8] dark:text-[#38BDF8] uppercase tracking-[0.18em] mb-3">Start Here</p>
                <h2 className="text-3xl md:text-4xl lg:text-[42px] font-bold tracking-tight">What most <span className="text-calgary-red">Calgarians</span> need.</h2>
              </motion.div>
            </div>
          ...
          <section className="px-6 md:px-8 lg:px-12 pb-12 md:pb-20 max-w-[1200px] mx-auto relative z-10">
            ...
            >
              ...
              <div className="relative z-10 p-5 md:p-8 lg:p-10 flex flex-col sm:flex-row sm:items-center gap-4 md:gap-6">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-bold text-[#E1251B] uppercase tracking-[0.18em] mb-1.5">Askonnect</p>
