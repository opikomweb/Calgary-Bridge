...
// Register sign-up success page strings for translation
registerStrings(
  "Check your email",
...
export default function SignUpSuccessPage() {
  const tx = useTranslations({
    ...
    successMsg: "We sent a confirmation link to your email. Click it to activate your account.",
    ...
    <div className="min-h-dvh flex items-center justify-center bg-background px-4 py-12">
      <div className="w-full max-w-sm text-center">
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-xl">
          ...
          <h1 className="text-xl font-bold text-foreground mb-2">{tx.checkEmail}</h1>
